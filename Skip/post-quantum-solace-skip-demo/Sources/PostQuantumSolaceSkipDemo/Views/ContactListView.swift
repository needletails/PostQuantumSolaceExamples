...
struct ContactListView: View {
    ...
    @State var presentedSheetType: SheetType?
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .automatic) {
                    Button(action: {
                        ...
                        Image.appToolbarAddContact
                    }
                }
                
                // Create channel (avoid unsupported SF Symbol on Android)
                ToolbarItem(placement: .automatic) {
                    Button(action: {
...
struct ChannelRow: View {
    ...
    let session: SessionManager
    @State var channelName: String = "Loading..."
    @State var isLoading: Bool = true
    
    var body: some View {
        NavigationLink(destination: ChannelChatView(channel: channel, session: session)) {
            HStack {
                // Custom channel icon that works across all platforms
                ZStack {
                    Circle()
